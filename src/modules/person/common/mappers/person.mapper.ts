...
import { City } from '../../common/address/entities/city.entity';
...
export function mapPersonData(
  ...
  person.emails =
    mapCollection(dto.emails, Email, (e, d) => {
      e.account = d.account;
    }) || [];

  person.phoneNumbers =
    mapCollection(dto.phoneNumbers, PhoneNumber, (p, d) => {
      p.number = d.number;
    }) || [];

  person.addresses =
    mapCollection(dto.addresses, Address, (a, d) => {
      a.street = d.street;
      ...
      if (d.cityId) {
        ...
        a.city = { id: d.cityId } as City;
      }
    }) || [];

  person.identifications =
    mapCollection(dto.identifications, Identification, (i, d) => {
      i.value = d.value;
